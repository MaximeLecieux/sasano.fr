			...
			emailjs
				...
				.then(
					() => {
						if (messageRef.current) {
							messageRef.current.textContent =
								"Message reçu 👍 Je vous répond dès que possible !";
						}
					...
					(error) => {
						if (messageRef.current) {
							messageRef.current.textContent =
								"Message non envoyé (service error) 👎";
						}
					}
				);
		}
		...
		>
			<div className="flex flex-col items-center gap-20 w-auto text-center">
				<div className="flex flex-col gap-6">
					<div>
						<Typography variant="lead" component="p">
							Ceci est un message afin de proposer au client de s’inscrire à la
							newsletter
						</Typography>
					</div>
					<div>
				...
				<div className="flex flex-col gap-6 items-center">
					<div>
						<Typography variant="lead" component="p">
							Ceci est un message afin de proposer au client de rentrer en
							contact s’il a des questions ou demandes à faire
						</Typography>
					</div>
